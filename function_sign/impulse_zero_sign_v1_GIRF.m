...
function [mimp, sign_t,A0_t] = impulse_zero_sign_v1_GIRF(nl, nlen, mb, ma, mh, method_type, policy_type,svar_type)
           ...
           switch policy_type
               case 'bench_mark'                   
                   [save_P(:,:,t),sign_P(:,t),sign_chk(t),A0_t(t,:,:)] = ...
                       zero_sign_restriction_v1(amOmsq,nk, t, nl,nlen, mbs, svar_type);
               case 'Choleski'                     
                   save_P(:,:,t) = eye(nk);
                   sign_P(:,t) =1;
                   sign_chk(t)=1;
